...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public override void OnInspectorGUI()
        {
...
#if ENABLE_INPUT_SYSTEM
            GUI.enabled = provider.InputActionAsset != null;
            if (GUILayout.Button(new GUIContent("Create Input Binding Settings", "If you have an InputAction asset assigned then this button will generate binding connections for all actions in that asset and add them to the settings list (strings).\n\n" +
            ...
            {
                InputBindingConnectionCreator.CreateBindingConnectionAssets(provider.InputActionAsset);
            }
            GUI.enabled = true;
#endif
