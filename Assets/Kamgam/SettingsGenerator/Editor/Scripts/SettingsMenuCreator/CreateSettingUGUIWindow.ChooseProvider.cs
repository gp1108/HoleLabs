...
namespace Kamgam.SettingsGenerator
{
    public partial class CreateSettingUGUIWindow : EditorWindow
    {
        ...
        private VisualElement createChooseProviderGUI(VisualElement root)
        {
            ...
            configCtn.AddLabel("The 'provider' is a configuration object that serves as a link to the settings. It 'provides' the settings to whoever needs it (thus the name).", "word-wrap", "mb-5");
                ...
                if (newProvider != null)
                {
                    if (!isDemoScene())
                    {
                        ...
                        else
                        {
                            ...
                            // Disabled as it was shown multiple times if set in rapid succession and confused users.
                            //Logger.LogWarning(
