...
namespace Kamgam.SettingsGenerator
{
    ...
    public partial class CreateSettingUGUIWindow : EditorWindow
    {
        ...
        private void onShowAddSettingDialog(ClickEvent evt)
        {
            ...
            //if (!_preferConsoleStyle.HasValue) // <- disabled because it's better to check every time (sometimes it got stuck on the wrong value).
            {
        ...
        void updateAddExistingSettingStyleChoices(ISetting setting)
        {
            ...
            if (setting != null)
            {
                ...
                {
                    // Pre-select console or pc style automatically.
