        ...
        public void CreateGUI()
        {
            ...
            EditorApplication.delayCall += () =>
            {
                if (!EditorApplication.isPlayingOrWillChangePlaymode && !docked)
                {
                    ...
                    LastOpenedWindow.titleContent = new GUIContent("Setting Creator - v" + SettingsGeneratorSettings.Version); //, icon);
            ...
            var configBtn = _tabbar.AddButton("Log", (e) => Selection.objects = new Object[] {SettingsGeneratorSettings.GetOrCreate()} );
            configBtn.tooltip = "Opens the base config settings.";
