/////////////////////////////////////////////////
//
//  This shows an outdated workflow (still works though) !
//
//  UPDATE: Please notice that in newer versions there are
//  SettingsSaver assets (SettingsSaverJson, SettingsSaverPlayerPrefs)
//  that you can use instead (drag in in the CreatorWindow).
//
//  This demo is for the old workflow but I decided to keep it
//  around for reference (and those who are used to doing it that way).
// 
/////////////////////////////////////////////////
using System.IO;
using UnityEngine;
