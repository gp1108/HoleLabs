...
namespace Kamgam.SettingsGenerator
{
    public static class SettingsGeneratorPrefabStyleConverter
    {
        ...
        public static string InputBindingPrefabName = "InputBindingUGUI (Setting)";
        public static string InputBindingConsolePrefabName = "InputBindingConsoleUGUI (Setting)";
        ...
        public static List<(string, List<SettingData.DataType>)> ValidPrefabsTypes =
            new List<(string, List<SettingData.DataType>)>()
            {
                ...
                (InputBindingPrefabName, new List<SettingData.DataType>() { SettingData.DataType.String }),
                (InputBindingConsolePrefabName, new List<SettingData.DataType>() { SettingData.DataType.String }),
