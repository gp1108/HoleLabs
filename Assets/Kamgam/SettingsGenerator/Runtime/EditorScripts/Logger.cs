...
namespace Kamgam.SettingsGenerator
{
    public class Logger
    {
        ...
        public static void LogInEditorOnly(string message, Object context = null) => Log(message, context);
        
        [Conditional("UNITY_EDITOR")]
        public static void LogWarningInEditorOnly(string message, Object context = null) => LogWarning(message, context);
        
        [Conditional("UNITY_EDITOR")]
        public static void LogErrorInEditorOnly(string message, Object context = null) => LogError(message, context);
        
        [Conditional("UNITY_EDITOR")]
        public static void LogMessageInEditorOnly(string message, Object context = null) => LogMessage(message, context);
