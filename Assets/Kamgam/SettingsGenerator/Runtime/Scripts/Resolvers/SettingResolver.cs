...
namespace Kamgam.SettingsGenerator
{
    ...
    public abstract class SettingResolver : MonoBehaviour, ISettingResolver
    {
        ...
        // Needed to get the actual set asset because since v1.68 SettingsProvider will use the default if asset is null.
        public SettingsProvider GetProviderAsset() => _settingsProvider;
        public SettingsProvider SetProviderAsset(SettingsProvider provider) => _settingsProvider = provider;
        ...
        public void RegisterAsActivated()
        {
            ...
            SettingsProvider.Settings.RegisterResolver(this);
        }
