...
namespace Kamgam.SettingsGenerator
{
    ...
    public interface ISetting : ISerializationCallbackReceiver, IQualityChangeReceiver, ISettingWithConnectionSO
    {
        ...
        /// <summary>
        /// The connection object (not the asset) for runtime use. This instantiates the connection objet if needed (and if possible). 
        /// </summary>
        /// <returns></returns>
        bool HasConnection();
        
        /// <summary>
        /// The Connection SO asset. This does not instantiate a runtime connection.
        /// </summary>
        /// <returns></returns>
        bool HasConnectionObject();
        
        /// <summary>
        /// Whenever a group of settings (or all) are applied, pulled or pushed then this will determine the order in which this is done.<br />
        /// An example of this is the quality setting. Quality is applied before any other setting so the explicit settings are overriding the defaults after a quality change (as they should).
        /// </summary>
        /// <returns></returns>
