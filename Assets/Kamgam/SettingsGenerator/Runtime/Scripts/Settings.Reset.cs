...
namespace Kamgam.SettingsGenerator
{
    public partial class Settings : ScriptableObject
    {
        ...
        public void DefragRegisteredResolvers()
        {
            ...
            {
                if (RegisteredResolvers[i] == null || (RegisteredResolvers[i] is UnityEngine.Object unityObj && unityObj == null))
        ...
        public void ResetControls()
        {
            ...
            foreach (var setting in _settingsCache)
            {
                ...
                else if (setting.HasConnection() && setting.GetConnectionInterface() is InputBindingConnection)
                {
                    setting.ResetToDefault();
                }
#endif
