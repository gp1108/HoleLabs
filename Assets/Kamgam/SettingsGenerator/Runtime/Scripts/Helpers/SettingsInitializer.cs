...
namespace Kamgam.SettingsGenerator
{
    ...
    public class SettingsInitializer : MonoBehaviour
    {
        ...
        /// <summary>
        /// Used only if DoNotDestroy is enabled.
        ...
        public class SettingsInitializerEditor : Editor
        {
            ...
            {
                EditorGUILayout.HelpBox("The SettingsInitializer is not longer required as the settings now initialize automatically in RuntimeInitializeLoadType > AfterSceneLoad." +
                                        "\n\nPlease consider removing it and use the configuration in the Creator Window (SettingsProvider) instead." +
                                        "\n\nHowever, if a SettingsInitializer is found in any scene it will be used and the provider init configuration will be ignored. " +
                                        "This is done to remain backwards compatible with older versions but it's no longer recommended to use the initializer." +
                                        "\n\nThe initializer can also be used to force initialization if DisableAutoInitialization is enabled in the provider.", MessageType.Info);
